...
<body style="font-size: 18px;">
    ...
    <form method="POST" action="hasil-form-regis.php" class="container mt-5" >
        <fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
            <legend class="float-none w-auto px-5 fw-bold h3">Form Registrasi IT Club Data Science</legend>
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nim" name="nim" placeholder="&quot;0110124027&quot;" type="text" class="form-control" required="required" pattern= "[0-9]{10}" title="NIM harus 10 digit angka" >
      </div>
    </div>
            </div>
            <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nama_lengkap" name="nama_lengkap" placeholder="&quot;ginanjara&quot;" type="text" class="form-control" required="required" minlength="3" maxlength="50">
      </div>
    </div>
            </div>
            <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="email" name="email" placeholder="&quot;budi01@gmail.com&quot;" type="email" class="form-control" required="required">
      </div>
    </div>
            </div> 
            <div class="form-group row">
